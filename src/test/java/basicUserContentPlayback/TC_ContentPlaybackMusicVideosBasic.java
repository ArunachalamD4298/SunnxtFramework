...
public class TC_ContentPlaybackMusicVideosBasic extends TestBase {
	
    private static final Logger logger = Log.getLogger(TC_ContentPlaybackMusicVideosBasic.class);
