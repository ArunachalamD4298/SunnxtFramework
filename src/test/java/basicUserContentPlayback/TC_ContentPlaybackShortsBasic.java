...
public class TC_ContentPlaybackShortsBasic extends TestBase{

	private static final Logger logger = Log.getLogger(TC_ContentPlaybackShortsBasic.class);
	...
	private void playBack() throws InterruptedException {
		...
		test = ExtentReportManager.createTest("Shorts Section Playback - Basic User");
		...
		implicitWait(30);
		test.info("Navigating to Shorts section");
		hp.contentPlayBackCheck(-1, -1);
		test.info("Navigating to random content");
